...
#define max_accel     1000//maximum robot acceleration
...
#define fwd       3 // Moving forward in progress flag
#define rev       4 // Moving reverse in progress flag
#define collide   5 // Stop and turn to avoid collide in progress flag
#define runAway   6 // 
#define wander    7 // wander in progress flag
#define botStop  0
