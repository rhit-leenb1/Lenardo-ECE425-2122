...
#define leftPhotocellPin 14
#define rightPhotocellPin 15

AccelStepper stepperRight(AccelStepper::DRIVER, rtStepPin, rtDirPin);//create instance of right stepper motor object (2 driver pins, low to high transition step pin 52, direction input pin 53 (high means forward)
AccelStepper stepperLeft(AccelStepper::DRIVER, ltStepPin, ltDirPin);//create instance of left stepper motor object (2 driver pins, step pin 50, direction input pin 51)
MultiStepper steppers;//create instance to control multiple steppers at the same time

long leftLightCalibration = 0;
long rightLightCalibration = 0;
int calibrationThreshhold = 1000;
...
void calibrateLight(int right, int left){
  leftLightCalibration = leftLightCalibration + left;
  rightLightCalibration = rightLightCalibration + right;
}
